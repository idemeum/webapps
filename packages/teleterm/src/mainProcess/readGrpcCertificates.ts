...
export async function readGrpcCertificates(certsDir: string): Promise<GrpcCertificates> {
    ...
    return {caCert: files[0], serverCert: files[1], serverKey: files[2], clientCert: files[3], clientKey: files[4] }
}
